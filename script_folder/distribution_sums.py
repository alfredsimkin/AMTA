...
first_output=open(data_folder+'eightmer_sums_by_species', 'w')
second_output=open(data_folder+'eightmer_sums_across_species', 'w')
...
eightmer_dict=cPickle.load(open(data_folder+'distributions_by_eightmer'))
