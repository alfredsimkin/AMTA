...
def calculate_final_probability(ancestor, descendant, final_probs, prob_dict, end_dict):
	...
	for eightmer in eightmer_list:
		...
		print eightmer
		print 'actual gains, losses:', three_number_dict[descendant][eightmer][1:]
...
final_probs=calculate_final_probability(ancestor, descendant, final_probs, prob_dict, end_dict)
exit()
