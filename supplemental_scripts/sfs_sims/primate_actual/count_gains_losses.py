...
ancestor_dict={'human':'3', 'chimp':'3', '3':'2', 'gorilla':'2', '2':'new', 'orangutan':'new', 'new':'1', 'gibbon':'1'}
descendant_dict={'1':['gibbon', 'new'], 'new':['orangutan', '2'], '2':['3', 'gorilla'], '3':['chimp', 'human']}
good_set=set(['A','C','G','T','a','c','g','t'])
output_string='sim_actual_counts'
full_dict=cPickle.load(open('sim_actual_dict2'))
...
#		print species, full_dict[gene][species]
	output_dict[gene]={'human':{}, 'gibbon':{}, 'chimp':{}, 'gorilla':{}, 'orangutan':{}, '3':{}, '2':{}, '1':{}, 'new':{}}
	for species in full_dict[gene]:
